...
<div class="page-header">
    <h1 class="page-title">طلبات المسوقين</h1>
</div>
...
<div class="filters-bar">
    ...
    <div class="filter-group">
        <label>البحث باسم المسوق</label>
        <input type="text" id="marketerSearch" placeholder="ابحث باسم المسوق...">
    </div>
</div>
...
<script>
    ...
    function renderRequests() {
        ...
        const marketerValue = document.getElementById('marketerSearch').value;
        ...
        let filtered = allRequests.filter(req => {
            ...
            if (marketerValue && !req.marketer_name.toLowerCase().includes(marketerValue.toLowerCase())) return false;
            return true;
        });
                ...
                <div class="request-card">
                    ...
                    <div class="request-content">
                        ...
                        <div class="request-actions">
                            <a href="/warehouse/requests/${req.id}" class="btn-view">عرض التفاصيل</a>
                        </div>
                    </div>
                </div>
            `;
