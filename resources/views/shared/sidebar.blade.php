<div class="sidebar">
    ...
    <div class="nav-menu">
        ...
        <a href="/admin/discounts" class="nav-link {{ request()->is('admin/discounts*') ? 'active' : '' }}">
            <span class="nav-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
            </span>
            <span class="nav-label">خصومات الفواتير</span>
        </a>
        <a href="/admin/promotions" class="nav-link {{ request()->is('admin/promotions*') ? 'active' : '' }}">
            ...
            <span class="nav-label">العروض الترويجية</span>
        </a>
        @endif
    </div>
