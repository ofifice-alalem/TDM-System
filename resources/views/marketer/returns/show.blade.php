...
<style>
    ...
    .modal-dialog { background: var(--card-light); border-radius: 20px; padding: 32px; max-width: 500px; width: 90%; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); position: relative; animation: slideUp 0.3s ease; }
    ...
    .modal-message { text-align: center; color: #64748b; margin-bottom: 28px; line-height: 1.6; font-size: 15px; }
    ...
    .image-modal-close { padding: 10px 20px; background: rgba(255, 255, 255, 0.1); color: white; border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 10px; cursor: pointer; font-weight: 700; font-size: 14px; transition: all 0.3s ease; display: flex; align-items: center; gap: 8px; }
