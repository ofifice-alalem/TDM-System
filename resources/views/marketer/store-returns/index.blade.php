...
<style>
    ...
    .return-info { flex: 1; display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 20px; align-items: center; }
...
<div class="page-header">
    ...
    <a href="/marketer/store-returns/create" class="btn-add">
...
<script>
    ...
    function renderReturns() {
        ...
        container.innerHTML = filtered.map(ret => {
            ...
            const date = new Date(ret.created_at).toLocaleDateString('en-US').replace(/\//g, '-');
            ...
            return `
                <div class="return-card">
                    ...
                    <a href="/marketer/store-returns/${ret.id}" class="btn-action">
                        عرض التفاصيل
